    ...
    <div v-else-if="eventDetailsStore.eventDetails" class="container mx-auto px-4 py-6 space-y-6 max-w-6xl">
      <div class="flex flex-col md:flex-row gap-6">
        ...
        <div class="flex flex-col full md:w-1/3 p-6 rounded-lg shadow-md bg-white space-y-4">
          ...
          <!-- Sold Out Message -->
          <div v-if="ticketAvailabilityStore.ticketAvailability.availableSeats === 0"
          ...
          <!-- Ticket Selection (Only if Available) -->
          <div v-else>
            <div class="flex flex-col items-center justify-center gap-4">
              <div class="flex items-center justify-between bg-violet-50 w-full px-4 py-4 rounded-xl">
                ...
                <input v-model="regularTickets" type="number" min="0"
                  ...
                  :disabled="ticketAvailabilityStore.ticketAvailability.availableSeats === 0" />
              </div>
            ...
            <!-- Reserve Button -->
            <button @click="reserveTickets"
              class="w-full bg-primary text-white py-3 rounded-xl shadow-md hover:bg-primary/80 focus:outline-none focus:ring-2 focus:ring-primary flex items-center justify-center space-x-2">
            ...
            <div v-else>
              You must login to our site to book this event!
            </div>
